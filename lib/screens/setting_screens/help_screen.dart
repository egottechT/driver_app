  ...
  lastCardView() {
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text("Help Tabs", style: TextStyle(color: secondaryColor,fontSize: 18,fontWeight: FontWeight.bold)),
          const SizedBox(height: 5,),
          iconWithText(Icon(Icons.person_pin,color: secondaryColor,), "My Account",
              "Accounts, Earn & Referral code, and more benefits"),
          spaceBetweenWidget(),
          iconWithText(
              Icon(Icons.currency_exchange,color: secondaryColor,),
              "Taxi Charges or Fare",
              "Book my etaxi offers car-sharing services.\nSo you can save your time & money"),
          spaceBetweenWidget(),
          iconWithText(Icon(Icons.safety_check,color: secondaryColor,), "Safety Term",
              "For any questions concerns or queries.\nWe're happy to talk with you."),
          spaceBetweenWidget(),
          iconWithText(
              Icon(Icons.car_rental,color: secondaryColor,),
